              ...
              <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownBlog">
                    ...
                    <a class="dropdown-item" href="submenu1_2.php">공지사항</a>
		 ...
		 <div id="sub1_2_information_area">
          <div class="sub1_2_info_section">
            <ul>
                ...
                <li>
                    <ul id ="sub1_2_ulTable">
                        ...
                        <li>
                            <ul>
                                <li><?=$row['idx']?></li>
                                <li class="left"><a href='submenu1_2_view.php'><?=$row['title']?></a></li>
                                <li><?=$_date?></li>
                                <li><?=$row['hit']?></li>
                            </ul>
                        </li>
                ...
                <li>
                    <!-- 글쓰기 버튼 영역 -->
                    <div class="sub1_2_information_wirte_btn">
                        <a href="board_write.php" style="color:#000; ">글쓰기</a>
                    </div>
                </li>
                <!-- 게시판 페이징 영역 -->
                <li>
